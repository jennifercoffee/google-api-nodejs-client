 ...
 */
export class Tagmanager extends BaseAPI {
              ...
              versions:
                  {
                    ...
                    publish(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Sets the latest version used for synchronization
                        * of workspaces when detecting conflicts and errors.
                        * @alias
                        * tagmanager.accounts.containers.versions.set_latest
                        * @memberOf! tagmanager(v2)
                        *
                    ...
                    set_latest(
                      ...
                      const parameters = {
                        options: Object.assign(
                            {
                              url:
                                  (rootUrl + '/tagmanager/v2/{path}:set_latest')
                                      .replace(/([^:]\/)\/+/g, '$1'),
                              method: 'POST'
                            },
                            options),
              ...
              workspaces:
                  {
                    ...
                    create(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * present in the workspace, deletes the workspace, and
                        * sets the base container version to the newly created
                        * version.
                        * @alias
                        * tagmanager.accounts.containers.workspaces.create_version
                        * @memberOf! tagmanager(v2)
                    ...
                    getStatus(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Lists all Workspaces that belong to a GTM
                        * Container.
                    ...
                    list(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * container version from all entities in the provided
                        * workspace.
                        * @alias
                        * tagmanager.accounts.containers.workspaces.quick_preview
                        * @memberOf! tagmanager(v2)
                    ...
                    quick_preview(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Resolves a merge conflict for a workspace entity
                        * by updating it to the resolved entity passed in the
                        * request.
                        * @alias
                        * tagmanager.accounts.containers.workspaces.resolve_conflict
                        * @memberOf! tagmanager(v2)
                    ...
                    resolve_conflict(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Syncs a workspace to the latest container
                        * version by updating all unmodified workspace entities
                    ...
                    built_in_variables:
                        {
                          ...
                          create(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Deletes one or more GTM Built-In
                              * Variables.
                              * @alias
                              * tagmanager.accounts.containers.workspaces.built_in_variables.delete
                              * @memberOf! tagmanager(v2)
                          ...
                          delete(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Lists all the enabled Built-In Variables
                              * of a GTM Container.
                              * @alias
                              * tagmanager.accounts.containers.workspaces.built_in_variables.list
                              * @memberOf! tagmanager(v2)
                          ...
                          list(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Reverts changes to a GTM Built-In
                              * Variables in a GTM Workspace.
                              * @alias
                              * tagmanager.accounts.containers.workspaces.built_in_variables.revert
                              * @memberOf! tagmanager(v2)
                              *
        ...
        user_permissions:
            {
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Removes a user from the account, revoking access to it
                  * and all of its containers.
              ...
              get(params: any, options: MethodOptions|BodyResponseCallback<any>,
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc List all users that have access to the account along
                  * with Account and Container user access granted to each of
                  * them.
 ...
 * @memberOf! tagmanager(v2)
 * @type object
 * @property {tagmanager(v2).Parameter[]} parameter A list of named parameters (key/value), depending on the condition&#39;s type. Notes:  - For binary operators, include parameters named arg0 and arg1 for specifying the left and right operands, respectively.  - At this time, the left operand (arg0) must be a reference to a variable.  - For case-insensitive Regex matching, include a boolean parameter named ignore_case that is set to true. If not specified or set to any other value, the matching will be case sensitive.  - To negate an operator, include a boolean parameter named negate boolean parameter that is set to true.

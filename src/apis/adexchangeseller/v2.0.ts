    ...
    customchannels:
        {
           ...
           * @desc Get the specified custom channel from the specified ad
           * client.
          ...
          get(params: any, options: MethodOptions|BodyResponseCallback<any>,
            ...
            createAPIRequest(parameters, callback!);
              ...
              * @desc List all custom channels in the specified ad client for
              * this Ad Exchange account.
    ...
    metadata:
        {
          ...
          metrics: {
             ...
             * @desc List the metadata for the metrics available to this
             * AdExchange account.
    ...
    preferreddeals:
        {
           ...
           * @desc Get information about the selected Ad Exchange Preferred
           * Deal.
    ...
    reports:
        {
           ...
           * @desc Generate an Ad Exchange report based on the report request
           * sent in the query parameters. Returns the result as JSON; to
           * retrieve output in CSV format specify "alt=csv" as a query
           * parameter.

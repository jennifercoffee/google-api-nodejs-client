 ...
 */
export class Runtimeconfig extends BaseAPI {
      ...
      variables:
          {
             ...
             * @desc Creates a variable within the given configuration. You
             * cannot create a variable with a name that is a prefix of an
             * existing variable name, or a name that has an existing variable
             * name as a prefix.  To learn more about creating a variable, read
             * the [Setting and Getting
            ...
            create(
              ...
              createAPIRequest(parameters, callback!);
                ...
                * @desc Deletes a variable or multiple variables.  If you
                * specify a variable name, then that variable is deleted. If you
                * specify a prefix and `recursive` is true, then all variables
                * with that prefix are deleted. You must set a `recursive` to
            ...
            get(params: any, options: MethodOptions|BodyResponseCallback<any>,
              ...
              createAPIRequest(parameters, callback!);
                ...
                * @desc Lists variables within given a configuration, matching
                * any provided filters. This only lists variable names, not the
                * values, unless `return_values` is true, in which case only
                * variables that user has IAM permission to GetVariable will be
                * returned.
            ...
            update(
              ...
              createAPIRequest(parameters, callback!);
                ...
                * @desc Watches a specific variable and waits for a change in
                * the variable's value. When there is a change, this method
                * returns the new value or times out.  If a variable is deleted
                * while being watched, the `variableState` state is set to
                * `DELETED` and the method returns the last known variable
                * `value`.  If you set the deadline for watching to a larger
                * value than internal timeout (60 seconds), the current variable
                * value is returned and the `variableState` will be
                * `VARIABLE_STATE_UNSPECIFIED`.  To learn more about creating a
                * watcher, read the [Watching a Variable for

        ...
        instances:
            {
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * the request:    * Billing ceases for all of the instance's
                  * reserved resources.  Soon afterward:    * The instance and
                  * *all of its databases* immediately and     irrevocably
                  * disappear from the API. All data in the databases     is
                  * permanently deleted.
              ...
              get(params: any, options: MethodOptions|BodyResponseCallback<any>,
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * resource. Returns an empty policy if an instance exists but
              ...
              list(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * instance. If the named instance does not exist, returns
                  * `NOT_FOUND`.  Immediately upon completion of this request:
                  * * For resource types for which a decrease in the instance's
                  * allocation     has been requested, billing is based on the
                  * newly-requested level.  Until completion of the returned
                  * operation:    * Cancelling the operation sets its metadata's
                  * cancel_time, and begins     restoring resources to their
                  * pre-request values. The operation     is guaranteed to
                  * succeed at undoing all resource changes,     after which
                  * point it terminates with a `CANCELLED` status.   * All other
                  * attempts to modify the instance are rejected.   * Reading
                  * the instance via the API continues to give the pre-request
                  * resource levels.  Upon completion of the returned operation:
                  * * Billing begins for all successfully-allocated resources
                  * (some types     may have lower than the requested levels).
                  * * All newly-reserved resources are available for serving the
                  * instance's     tables.   * The instance's new resource
                  * levels are readable via the API.  The returned long-running
                  * operation will have a name of the format
                  * `<instance_name>/operations/<operation_id>` and can be used
                  * to track the instance modification.  The metadata field type
                  * is UpdateInstanceMetadata. The response field type is
                  * Instance, if successful.  Authorization requires
              ...
              patch(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * resource. Replaces any existing policy.  Authorization
              ...
              setIamPolicy(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * specified instance resource.  Attempting this RPC on a
                  * non-existent Cloud Spanner instance resource will result in
                  * a NOT_FOUND error if the user has `spanner.instances.list`
                  * permission on the containing Google Cloud Project. Otherwise
              ...
              databases:
                  {
                    ...
                    get(params: any,
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * as a list of formatted DDL statements. This method
                        * does not show pending schema updates, those may be
                    ...
                    getDdl(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * resource. Returns an empty policy if a database exists
                        * but does not have a policy set.  Authorization
                        * requires `spanner.databases.getIamPolicy` permission
                        * on resource.
                        * @alias
                        * spanner.projects.instances.databases.getIamPolicy
                        * @memberOf! spanner(v1)
                    ...
                    list(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * resource. Replaces any existing policy.  Authorization
                        * requires `spanner.databases.setIamPolicy` permission
                        * on resource.
                        * @alias
                        * spanner.projects.instances.databases.setIamPolicy
                        * @memberOf! spanner(v1)
                    ...
                    setIamPolicy(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Returns permissions that the caller has on the
                        * specified database resource.  Attempting this RPC on a
                        * non-existent Cloud Spanner database will result in a
                        * NOT_FOUND error if the user has
                        * `spanner.databases.list` permission on the containing
                        * Cloud Spanner instance. Otherwise returns an empty set
                        * of permissions.
                        * @alias
                        * spanner.projects.instances.databases.testIamPermissions
                        * @memberOf! spanner(v1)
                    ...
                    testIamPermissions(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * by creating/altering/dropping tables, columns,
                        * indexes, etc. The returned long-running operation will
                        * have a name of the format
                        * `<database_name>/operations/<operation_id>` and can be
                        * used to track execution of the schema change(s). The
                        * metadata field type is UpdateDatabaseDdlMetadata.  The
 ...
 * @property {string} type The type of the link. For example, in Hash Joins this could be used to distinguish between the build child and the probe child, or in the case of the child being an output variable, to represent the tag associated with the output variable.
 * @property {string} variable Only present if the child node is SCALAR and corresponds to an output variable of the parent node. The field carries the name of the output variable. For example, a `TableScan` operator that reads rows from a table will have child links to the `SCALAR` nodes representing the output variables created for each column that is read by the operator. The corresponding `variable` fields will be set to the variable names assigned to the columns.
 */
/**
 * @typedef CommitRequest
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Mutation[]} mutations The mutations to be executed when this transaction commits. All mutations are applied atomically, in the order they appear in this list.
 * @property {spanner(v1).TransactionOptions} singleUseTransaction Execute mutations in a temporary transaction. Note that unlike commit of a previously-started transaction, commit with a temporary transaction is non-idempotent. That is, if the `CommitRequest` is sent to Cloud Spanner more than once (for instance, due to retries in the application, or in the transport library), it is possible that the mutations are executed more than once. If this is undesirable, use BeginTransaction and Commit instead.
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} createStatement Required. A `CREATE DATABASE` statement, which specifies the ID of the new database.  The database ID must conform to the regular expression `a-z*[a-z0-9]` and be between 2 and 30 characters in length. If the database ID is a reserved word or if it contains a hyphen, the database ID must be enclosed in backticks (`` ` ``).
 * @property {string[]} extraStatements An optional list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created.
 */
/**
 * @typedef CreateInstanceMetadata
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} cancelTime The time at which this operation was cancelled. If set, this operation is in the process of undoing itself (which is guaranteed to succeed) and cannot be cancelled again.
 ...
 * @property {string} startTime The time at which the CreateInstance request was received.
 */
/**
 * @typedef CreateInstanceRequest
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Instance} instance Required. The instance to create.  The name may be omitted, but if specified must be `&lt;parent&gt;/instances/&lt;instance_id&gt;`.
 * @property {string} instanceId Required. The ID of the instance to create.  Valid identifiers are of the form `a-z*[a-z0-9]` and must be between 6 and 30 characters in length.
 */
/**
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} name Required. The name of the database. Values are of the form `projects/&lt;project&gt;/instances/&lt;instance&gt;/databases/&lt;database&gt;`, where `&lt;database&gt;` is as specified in the `CREATE DATABASE` statement. This name can be passed to other API methods to identify the database.
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} name The name of the field. For reads, this is the column name. For SQL queries, it is the column alias (e.g., `&quot;Word&quot;` in the query `&quot;SELECT &#39;hello&#39; AS Word&quot;`), or the column name (e.g., `&quot;ColName&quot;` in the query `&quot;SELECT ColName FROM Table&quot;`). Some columns might have an empty name (e.g., !&quot;SELECT UPPER(ColName)&quot;`). Note that a query result can contain multiple fields with the same name.
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string[]} statements A list of formatted DDL statements defining the schema of the database specified in the request.
 */
/**
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} config Required. The name of the instance&#39;s configuration. Values are of the form `projects/&lt;project&gt;/instanceConfigs/&lt;configuration&gt;`. See also InstanceConfig and ListInstanceConfigs.
 * @property {string} displayName Required. The descriptive name for this instance as it appears in UIs. Must be unique per project and between 4 and 30 characters in length.
 * @property {object} labels Cloud Labels are a flexible and lightweight mechanism for organizing cloud resources into groups that reflect a customer&#39;s organizational needs and deployment strategies. Cloud Labels can be used to filter collections of resources. They can be used to control how resource metrics are aggregated. And they can be used as arguments to policy management rules (e.g. route, firewall, load balancing, etc.).   * Label keys must be between 1 and 63 characters long and must conform to    the following regular expression: `[a-z]([-a-z0-9]*[a-z0-9])?`.  * Label values must be between 0 and 63 characters long and must conform    to the regular expression `([a-z]([-a-z0-9]*[a-z0-9])?)?`.  * No more than 64 labels can be associated with a given resource.  See https://goo.gl/xmQnxf for more information on and examples of labels.  If you plan to use labels in your own code, please note that additional characters may be allowed in the future. And so you are advised to use an internal label representation, such as JSON, which doesn&#39;t rely upon specific characters being disallowed.  For example, representing labels as the string:  name + &quot;_&quot; + value  would prove problematic if we were to allow &quot;_&quot; in a future release.
 * @property {string} name Required. A unique identifier for the instance, which cannot be changed after the instance is created. Values are of the form `projects/&lt;project&gt;/instances/a-z*[a-z0-9]`. The final segment of the name must be between 6 and 30 characters in length.
 * @property {integer} nodeCount Required. The number of nodes allocated to this instance. This may be zero in API responses for instances that are not yet in state `READY`.  See [the documentation](https://cloud.google.com/spanner/docs/instances#node_count) for more information about nodes.
 * @property {string} state Output only. The current instance state. For CreateInstance, the state must be either omitted or set to `CREATING`. For UpdateInstance, the state must be either omitted or set to `READY`.
 */
/**
 ...
 * @property {string} name A unique identifier for the instance configuration.  Values are of the form `projects/&lt;project&gt;/instanceConfigs/a-z*`
 */
/**
 * @typedef KeyRange
 * @memberOf! spanner(v1)
 * @type object
 * @property {any[]} endClosed If the end is closed, then the range includes all rows whose first `len(end_closed)` key columns exactly match `end_closed`.
 * @property {any[]} endOpen If the end is open, then the range excludes rows whose first `len(end_open)` key columns exactly match `end_open`.
 * @property {any[]} startClosed If the start is closed, then the range includes all rows whose first `len(start_closed)` key columns exactly match `start_closed`.
 * @property {any[]} startOpen If the start is open, then the range excludes rows whose first `len(start_open)` key columns exactly match `start_open`.
 */
/**
 * @typedef KeySet
 * @memberOf! spanner(v1)
 * @type object
 * @property {boolean} all For convenience `all` can be set to `true` to indicate that this `KeySet` matches all keys in the table or index. Note that any keys specified in `keys` or `ranges` are only yielded once.
 * @property {array[]} keys A list of specific keys. Entries in `keys` should have exactly as many elements as there are columns in the primary or index key with which this `KeySet` is used.  Individual key values are encoded as described here.
 * @property {spanner(v1).KeyRange[]} ranges A list of key ranges. See KeyRange for more information about key range specifications.
 */
/**
 ...
 * @property {string} nextPageToken `next_page_token` can be sent in a subsequent ListDatabases call to fetch more of the matching databases.
 */
/**
 ...
 * @property {string} nextPageToken `next_page_token` can be sent in a subsequent ListInstanceConfigs call to fetch more of the matching instance configurations.
 */
/**
 ...
 * @property {string} nextPageToken `next_page_token` can be sent in a subsequent ListInstances call to fetch more of the matching instances.
 */
/**
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} nextPageToken `next_page_token` can be sent in a subsequent ListSessions call to fetch more of the matching sessions.
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Delete} delete Delete rows from a table. Succeeds whether or not the named rows were present.
 * @property {spanner(v1).Write} insert Insert new rows in a table. If any of the rows already exist, the write or transaction fails with error `ALREADY_EXISTS`.
 * @property {spanner(v1).Write} insertOrUpdate Like insert, except that if the row already exists, then its column values are overwritten with the ones provided. Any column values not explicitly written are preserved.
 * @property {spanner(v1).Write} replace Like insert, except that if the row already exists, it is deleted, and the column values provided are inserted instead. Unlike insert_or_update, this means any values not explicitly written become `NULL`.
 * @property {spanner(v1).Write} update Update existing rows in a table. If any of the rows does not already exist, the transaction fails with error `NOT_FOUND`.
 */
/**
 * @typedef Operation
 * @memberOf! spanner(v1)
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {boolean} chunkedValue If true, then the final value in values is chunked, and must be combined with more values from subsequent `PartialResultSet`s to obtain a complete field value.
 * @property {spanner(v1).ResultSetMetadata} metadata Metadata about the result set, such as row type information. Only present in the first response.
 ...
 * @property {spanner(v1).ResultSetStats} stats Query plan and execution statistics for the query that produced this streaming result set. These can be requested by setting ExecuteSqlRequest.query_mode and are sent only once with the last response in the stream.
 ...
 * @property {object} executionStats The execution statistics associated with the node, contained in a group of key-value pairs. Only present if the plan was returned as a result of a profile query. For example, number of executions, number of rows/time per execution etc.
 * @property {integer} index The `PlanNode`&#39;s index in node list.
 * @property {string} kind Used to determine the type of node. May be needed for visualizing different kinds of nodes differently. For example, If the node is a SCALAR node, it will have a condensed representation which can be used to directly embed a description of the node in its parent.
 * @property {object} metadata Attributes relevant to the node contained in a group of key-value pairs. For example, a Parameter Reference node could have the following information in its metadata:      {       &quot;parameter_reference&quot;: &quot;param1&quot;,       &quot;parameter_type&quot;: &quot;array&quot;     }
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).PlanNode[]} planNodes The nodes in the query plan. Plan nodes are returned in pre-order starting with the plan root. Each PlanNode&#39;s `id` corresponds to its index in `plan_nodes`.
 */
/**
 * @typedef ReadOnly
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} exactStaleness Executes all reads at a timestamp that is `exact_staleness` old. The timestamp is chosen soon after the read is started.  Guarantees that all writes that have committed more than the specified number of seconds ago are visible. Because Cloud Spanner chooses the exact timestamp, this mode works even if the client&#39;s local clock is substantially skewed from Cloud Spanner commit timestamps.  Useful for reading at nearby replicas without the distributed timestamp negotiation overhead of `max_staleness`.
 * @property {string} maxStaleness Read data at a timestamp &gt;= `NOW - max_staleness` seconds. Guarantees that all writes that have committed more than the specified number of seconds ago are visible. Because Cloud Spanner chooses the exact timestamp, this mode works even if the client&#39;s local clock is substantially skewed from Cloud Spanner commit timestamps.  Useful for reading the freshest data available at a nearby replica, while bounding the possible staleness if the local replica has fallen behind.  Note that this option can only be used in single-use transactions.
 * @property {string} minReadTimestamp Executes all reads at a timestamp &gt;= `min_read_timestamp`.  This is useful for requesting fresher data than some previous read, or data that is fresh enough to observe the effects of some previously committed transaction whose timestamp is known.  Note that this option can only be used in single-use transactions.  A timestamp in RFC3339 UTC \&quot;Zulu\&quot; format, accurate to nanoseconds. Example: `&quot;2014-10-02T15:01:23.045123456Z&quot;`.
 * @property {string} readTimestamp Executes all reads at the given timestamp. Unlike other modes, reads at a specific timestamp are repeatable; the same read at the same timestamp always returns the same data. If the timestamp is in the future, the read will block until the specified timestamp, modulo the read&#39;s deadline.  Useful for large scale consistent reads such as mapreduces, or for coordinating many reads against a consistent snapshot of the data.  A timestamp in RFC3339 UTC \&quot;Zulu\&quot; format, accurate to nanoseconds. Example: `&quot;2014-10-02T15:01:23.045123456Z&quot;`.
 * @property {boolean} returnReadTimestamp If true, the Cloud Spanner-selected read timestamp is included in the Transaction message that describes the transaction.
 * @property {boolean} strong Read at a timestamp where all previously committed transactions are visible.
 */
/**
 * @typedef ReadRequest
 * @memberOf! spanner(v1)
 ...
 * @property {array[]} rows Each element in `rows` is a row whose format is defined by metadata.row_type. The ith element in each row matches the ith field in metadata.row_type. Elements are encoded based on type as described here.
 * @property {spanner(v1).ResultSetStats} stats Query plan and execution statistics for the query that produced this result set. These can be requested by setting ExecuteSqlRequest.query_mode.
 */
/**
 * @typedef ResultSetMetadata
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).StructType} rowType Indicates the field names and types for the rows in the result set.  For example, a SQL query like `&quot;SELECT UserId, UserName FROM Users&quot;` could return a `row_type` value like:      &quot;fields&quot;: [       { &quot;name&quot;: &quot;UserId&quot;, &quot;type&quot;: { &quot;code&quot;: &quot;INT64&quot; } },       { &quot;name&quot;: &quot;UserName&quot;, &quot;type&quot;: { &quot;code&quot;: &quot;STRING&quot; } },     ]
 * @property {spanner(v1).Transaction} transaction If the read or SQL query began a transaction as a side-effect, the information about the new transaction is yielded here.
 */
/**
 ...
 * @property {object} queryStats Aggregated statistics from the execution of the query. Only present when the query is profiled. For example, a query could return the statistics as follows:      {       &quot;rows_returned&quot;: &quot;3&quot;,       &quot;elapsed_time&quot;: &quot;1.22 secs&quot;,       &quot;cpu_time&quot;: &quot;1.19 secs&quot;     }
 */
/**
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} approximateLastUseTime Output only. The approximate timestamp when the session is last used. It is typically earlier than the actual last use time.
 * @property {string} createTime Output only. The timestamp when the session is created.
 * @property {object} labels The labels for the session.   * Label keys must be between 1 and 63 characters long and must conform to    the following regular expression: `[a-z]([-a-z0-9]*[a-z0-9])?`.  * Label values must be between 0 and 63 characters long and must conform    to the regular expression `([a-z]([-a-z0-9]*[a-z0-9])?)?`.  * No more than 64 labels can be associated with a given session.  See https://goo.gl/xmQnxf for more information on and examples of labels.
 * @property {string} name The name of the session. This is always system-assigned; values provided when creating a session are ignored.
 */
/**
 * @typedef SetIamPolicyRequest
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Policy} policy REQUIRED: The complete policy to be applied to the `resource`. The size of the policy is limited to a few 10s of KB. An empty policy is a valid policy but certain Cloud Platform services (such as Projects) might reject them.
 */
/**
 ...
 * @property {object} subqueries A mapping of (subquery variable name) -&gt; (subquery node id) for cases where the `description` string of this node references a `SCALAR` subquery contained in the expression subtree rooted at this node. The referenced `SCALAR` subquery may not necessarily be a direct child of this node.
 */
/**
 * @typedef Status
 * @memberOf! spanner(v1)
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Field[]} fields The list of fields that make up this struct. Order is significant, because values of this struct type are represented as lists, where the order of field values matches the order of fields in the StructType. In turn, the order of fields matches the order of columns in a read request, or the order of fields in the `SELECT` clause of a query.
 */
/**
 * @typedef TestIamPermissionsRequest
 * @memberOf! spanner(v1)
 * @type object
 * @property {string[]} permissions REQUIRED: The set of permissions to check for &#39;resource&#39;. Permissions with wildcards (such as &#39;*&#39;, &#39;spanner.*&#39;, &#39;spanner.instances.*&#39;) are not allowed.
 */
/**
 ...
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} id `id` may be used to identify the transaction in subsequent Read, ExecuteSql, Commit, or Rollback calls.  Single-use read-only transactions do not have IDs, because single-use transactions do not support multiple requests.
 * @property {string} readTimestamp For snapshot read-only transactions, the read timestamp chosen for the transaction. Not returned by default: see TransactionOptions.ReadOnly.return_read_timestamp.  A timestamp in RFC3339 UTC \&quot;Zulu\&quot; format, accurate to nanoseconds. Example: `&quot;2014-10-02T15:01:23.045123456Z&quot;`.
 */
/**
 * @typedef TransactionOptions
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).ReadOnly} readOnly Transaction will not write.  Authorization to begin a read-only transaction requires `spanner.databases.beginReadOnlyTransaction` permission on the `session` resource.
 * @property {spanner(v1).ReadWrite} readWrite Transaction may write.  Authorization to begin a read-write transaction requires `spanner.databases.beginOrRollbackReadWriteTransaction` permission on the `session` resource.
 */
/**
 * @typedef TransactionSelector
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).TransactionOptions} begin Begin a new transaction and execute this read or SQL query in it. The transaction ID of the new transaction is returned in ResultSetMetadata.transaction, which is a Transaction.
 * @property {string} id Execute the read or SQL query in a previously-started transaction.
 * @property {spanner(v1).TransactionOptions} singleUse Execute the read or SQL query in a temporary transaction. This is the most efficient way to execute a transaction that consists of a single SQL query.
 */
/**
 * @typedef Type
 * @memberOf! spanner(v1)
 * @type object
 * @property {spanner(v1).Type} arrayElementType If code == ARRAY, then `array_element_type` is the type of the array elements.
 * @property {string} code Required. The TypeCode for this type.
 * @property {spanner(v1).StructType} structType If code == STRUCT, then `struct_type` provides type information for the struct&#39;s fields.
 */
/**
 * @typedef UpdateDatabaseDdlMetadata
 * @memberOf! spanner(v1)
 * @type object
 * @property {string[]} commitTimestamps Reports the commit timestamps of all statements that have succeeded so far, where `commit_timestamps[i]` is the commit timestamp for the statement `statements[i]`.
 * @property {string} database The database being modified.
 * @property {string[]} statements For an update this list contains all the statements. For an individual statement, this list contains only that statement.
 */
/**
 ...
 * @property {string} startTime The time at which UpdateInstance request was received.
 */
/**
 * @typedef UpdateInstanceRequest
 * @memberOf! spanner(v1)
 * @type object
 * @property {string} fieldMask Required. A mask specifying which fields in [][google.spanner.admin.instance.v1.UpdateInstanceRequest.instance] should be updated. The field mask must always be specified; this prevents any future fields in [][google.spanner.admin.instance.v1.Instance] from being erased accidentally by clients that do not know about them.
 * @property {spanner(v1).Instance} instance Required. The instance to update, which must always include the instance name.  Otherwise, only fields mentioned in [][google.spanner.admin.instance.v1.UpdateInstanceRequest.field_mask] need be included.
 */
/**
 * @typedef Write
 * @memberOf! spanner(v1)
 * @type object
 * @property {string[]} columns The names of the columns in table to be written.  The list of columns must contain enough columns to allow Cloud Spanner to derive values for all primary key columns in the row(s) to be modified.

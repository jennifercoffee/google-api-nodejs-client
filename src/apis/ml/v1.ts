 ...
 */
export class Ml extends BaseAPI {
  ...
  projects =
      {
         ...
         * @desc Get the service account information associated with your
         * project. You need this information in order to grant the service
         * account persmissions for the Google Cloud Storage location where you
        ...
        getConfig(
          ...
          createAPIRequest(parameters, callback!);
            ...
            * ml.projects.predict
            * @desc Performs prediction on the data in the request. Cloud ML
            * Engine implements a custom `predict` verb on top of an HTTP POST
            * method. <p>For details of the request and response format, see the
            * **guide to the [predict request
        ...
        jobs:
            {
              ...
              getIamPolicy(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Lists the jobs in the project.  If there are no jobs
                  * that match the request parameters, the list request returns
              ...
              setIamPolicy(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * resource. If the resource does not exist, this will return
                  * an empty set of permissions, not a NOT_FOUND error.  Note:
                  * This operation is designed to be used for building
        ...
        locations:
            {
               ...
               * @desc Get the complete list of CMLE capabilities in a location,
               * along with their location-specific properties.
              ...
              get(params: any, options: MethodOptions|BodyResponseCallback<any>,
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc List all locations that provides at least one type of
                  * CMLE capability.
        ...
        models:
            {
               ...
               * @desc Creates a model which will later contain one or more
               * versions.  You must add at least one version before you can
               * request predictions from the model. Add versions by calling
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Deletes a model.  You can only delete a model if there
                  * are no versions in it. You can delete versions by calling
              ...
              delete(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Gets information about a model, including its name,
                  * the description (if set), and the default version (if at
                  * least one version of the model has been deployed).
              ...
              getIamPolicy(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Lists the models in a project.  Each project can
                  * contain multiple models, and each model can have multiple
                  * versions.  If there are no models that match the request
              ...
              versions:
                  {
                     ...
                     * @desc Creates a new version of a model from a trained
                     * TensorFlow model.  If the version created in the cloud by
                     * this call is the first deployed version of the specified
                     * model, it will be made the default version of the model.
                     * When you add a version to a model that already has one or
                     * more versions, the default version does not automatically
                     * change. If you want a new version to be the default, you
                     * must call
                    ...
                    create(
                      ...
                      options = options || {};
                      const rootUrl =
                          options.rootUrl || 'https://ml.googleapis.com/';
                      const parameters = {
                        options: Object.assign(
                            {
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Deletes a model version.  Each model can have
                        * multiple versions deployed and in use at any given
                        * time. Use this method to remove a single version.
                        * Note: You cannot delete the version that is set as the
                        * default version of the model unless it is the only
                        * remaining version.
                    ...
                    delete(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Gets information about a model version.  Models
                        * can have multiple versions. You can call
                        * [projects.models.versions.list](/ml-engine/reference/rest/v1/projects.models.versions/list)
                        * to get the same information that this method returns
                        * for all of the versions of a model.
                    ...
                    get(params: any,
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Gets basic information about all the versions of
                        * a model.  If you expect that a model has many
                        * versions, or if you need to handle only a limited
                        * number of results at a time, you can request that the
                        * list be retrieved in batches (called pages).  If there
                        * are no versions that match the request parameters, the
                    ...
                    list(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Updates the specified Version resource.
                        * Currently the only supported field to update is
                        * `description`.
                    ...
                    patch(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Designates a version to be the default for the
                        * model.  The default version is used for prediction
                        * requests made against the model that don't specify a
                        * version.  The first version to be created for a model
                        * is automatically set as the default. You must make any
                        * subsequent changes to the default version setting
        ...
        operations:
            {
               ...
               * despite cancellation. On successful cancellation, the operation
               * is not deleted; instead, it becomes an operation with an
 ...
 * @property {number} maxValue Required if type is `DOUBLE` or `INTEGER`. This field should be unset if type is `CATEGORICAL`. This value should be integers if type is `INTEGER`.
 ...
 * @property {string} pythonVersion Optional. The version of Python used in prediction. If not set, the default version is &#39;2.7&#39;. Python &#39;3.5&#39; is available when `runtime_version` is set to &#39;1.4&#39; and above. Python &#39;2.7&#39; works with all supported runtime versions.

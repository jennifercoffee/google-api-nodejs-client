 ...
 */
export class Cloudkms extends BaseAPI {
                ...
                cryptoKeys:
                    {
                      ...
                      decrypt(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * @desc Encrypts data, so that it can only be
                          * recovered by a call to Decrypt.
                          * @alias
                          * cloudkms.projects.locations.keyRings.cryptoKeys.encrypt
                          * @memberOf! cloudkms(v1)
                          *
                      ...
                      encrypt(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * @desc Returns metadata for a given CryptoKey, as
                          * well as its primary CryptoKeyVersion.
                          * @alias
                          * cloudkms.projects.locations.keyRings.cryptoKeys.get
                          * @memberOf! cloudkms(v1)
                          *
                      ...
                      patch(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * @desc Sets the access control policy on the
                      ...
                      setIamPolicy(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * @desc Returns permissions that a caller has on the
                          * specified resource. If the resource does not exist,
                          * this will return an empty set of permissions, not a
                          * NOT_FOUND error.  Note: This operation is designed
                          * to be used for building permission-aware UIs and
                          * command-line tools, not for authorization checking.
                      ...
                      cryptoKeyVersions:
                          {
                             ...
                             * @desc Create a new CryptoKeyVersion in a
                             * CryptoKey.  The server will assign the next
                             * sequential id. If unset, state will be set to
                             * ENABLED.
                             * @alias
                             * cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.create
                             * @memberOf! cloudkms(v1)
                            ...
                            create(
                              ...
                              createAPIRequest(parameters, callback!);
                                ...
                                * @desc Schedule a CryptoKeyVersion for
                                * destruction.  Upon calling this method,
                                * CryptoKeyVersion.state will be set to
                                * DESTROY_SCHEDULED and destroy_time will be set
                                * to a time 24 hours in the future, at which
                                * point the state will be changed to DESTROYED,
                                * and the key material will be irrevocably
                                * destroyed.  Before the destroy_time is
                                * reached, RestoreCryptoKeyVersion may be called
                            ...
                            list(
                              ...
                              createAPIRequest(parameters, callback!);
                                ...
                                * state may be changed between ENABLED and
                                * DISABLED using this method. See
                                * DestroyCryptoKeyVersion and
                            ...
                            patch(
                              ...
                              createAPIRequest(parameters, callback!);
                                ...
                                * DESTROY_SCHEDULED, state.  Upon restoration of
                                * the CryptoKeyVersion, state will be set to

 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1QuasiIdField[]} quasiIds Quasi-identifier columns. [required]
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} relativeFrequency The relative frequency column must contain a floating-point number between 0 and 1 (inclusive). Null values are assumed to be zero. [required]
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1BigQueryTable} table Auxiliary table location. [required]
 */
/**
 * @typedef GooglePrivacyDlpV2beta1BigQueryKey
 * @memberOf! dlp(v2beta1)
 * @type object
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId[]} identifyingFields References to fields uniquely identifying rows within the table. Nested fields in the format, like `person.birthdate.year`, are allowed.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1BigQueryTable} tableReference Complete BigQuery table reference.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value} min Lower bound of the range, inclusive. Type should be the same as max if used.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value} replacementValue Replacement value for this bucket. If not provided the default behavior will be to hyphenate the min-max range.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} field Field to compute categorical stats on. All column types are supported except for arrays and structs. However, it may be more informative to use NumericalStats when the field type is supported, depending on the data.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1ValueFrequency[]} bucketValues Sample of value frequencies in this bucket. The total number of values returned per bucket is capped at 20.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1CharsToIgnore[]} charactersToIgnore When masking a string, items in this list will be skipped when replacing. For example, if your string is 555-555-5555 and you ask us to skip `-` and mask 5 chars with * we would produce ***-*55-5555.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1PartitionId} partitionId A partition ID identifies a grouping of entities. The grouping is always by project and namespace, however the namespace ID may be empty.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Projection[]} projection Properties to scan. If none are specified, all properties will be scanned by default.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoTypeTransformations} infoTypeTransformations Treat the dataset as free-form text and apply the same free text transformation everywhere.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1RecordTransformations} recordTransformations Treat the dataset as structured. Transformations can be applied to specific locations within structured datasets, such as transforming a column within a table.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InspectConfig} inspectConfig Configuration for the inspector.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1ContentItem[]} items The list of items to inspect. Up to 100 are allowed per request. All items will be treated as text/*.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1RecordCondition} condition Only apply the transformation if the condition evaluates to true for the given `RecordCondition`. The conditions are allowed to reference fields that are not used in the actual transformation. [optional]  Example Use Cases:  - Apply a different bucket transformation to an age column if the zip code column for the same record is within a specific range. - Redact a field if the date of birth field is greater than 85.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId[]} fields Input field(s) to apply the transformation to. [required]
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoTypeTransformations} infoTypeTransformations Treat the contents of the field as free text, and selectively transform content that matches an `InfoType`.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value} lowerBound Lower bound value of buckets. All values less than `lower_bound` are grouped together into a single bucket; for example if `lower_bound` = 10, then all values less than 10 are replaced with the value “-10”. [Required].
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value} upperBound Upper bound value of buckets. All values greater than upper_bound are grouped together into a single bucket; for example if `upper_bound` = 89, then all values greater than 89 are replaced with the value “89+”. [Required].
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType} infoType Only one per info_type should be provided per request. If not specified, and redact_all_text is false, the DLP API will redact all text that it matches against all info_types that are found, but not specified in another ImageRedactionConfig.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Color} redactionColor The color to use when redacting content from an image. If not specified, the default is black.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType[]} infoTypes Info types to apply the transformation to. Empty list will match all available info types for this transformation.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoTypeTransformation[]} transformations Transformation for each info type. Cannot specify more than one for a given info type. [required]
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType[]} infoTypes Restricts what info_types to look for. The values must correspond to InfoType values returned by ListInfoTypes or found in documentation. Empty info_types runs all enabled detectors.
 ...
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InspectConfig} inspectConfig Configuration for the inspector.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1ContentItem[]} items The list of items to inspect. Items in a single request are considered &quot;related&quot; unless inspect_config.independent_inputs is true. Up to 100 are allowed per request.
 */
/**
 * @typedef GooglePrivacyDlpV2beta1InspectContentResponse
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InspectResult[]} results Each content_item from the request has a result in this list, in the same order as the request.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value[]} quasiIdsValues Set of values defining the equivalence class. One value per quasi-identifier column in the original KAnonymity metric message. The order is always the same as the original request.
 */
/**
 ...
 * @type object
 * @property {string} bucketSize Total number of records in this bucket.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KAnonymityEquivalenceClass[]} bucketValues Sample of equivalence classes in this bucket. The total number of classes returned per bucket is capped at 20.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1PartitionId} partitionId Entities are partitioned into subsets, currently identified by a project ID and namespace ID. Queries are scoped to a single partition.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1PathElement[]} path The entity path. An entity path consists of one or more elements composed of a kind and a string or numerical identifier, which identify entities. The first element identifies a _root entity_, the second element identifies a _child_ of the root entity, the third element identifies a child of the second entity, and so forth. The entities identified by all prefixes of the path are called the element&#39;s _ancestors_.  A path can never be empty, and a path can have at most 100 elements.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1AuxiliaryTable[]} auxiliaryTables Several auxiliary tables can be used in the analysis. Each custom_tag used to tag a quasi-identifiers column must appear in exactly one column of one auxiliary table.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1TaggedField[]} quasiIds Fields considered to be quasi-identifiers. No two columns can have the same tag. [required]
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KMapEstimationQuasiIdValues[]} bucketValues Sample of quasi-identifier tuple values in this bucket. The total number of classes returned per bucket is capped at 20.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId[]} quasiIds Set of quasi-identifiers indicating how equivalence classes are defined for the l-diversity computation. When multiple fields are specified, they are considered a single composite key.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value[]} quasiIdsValues Quasi-identifier values defining the k-anonymity equivalence class. The order is always the same as the original request.
 ...
 * @type object
 * @property {string} bucketSize Total number of records in this bucket.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1LDiversityEquivalenceClass[]} bucketValues Sample of equivalence classes in this bucket. The total number of classes returned per bucket is capped at 20.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {string} nextPageToken If not empty, indicates that there may be more results that match the request; this value should be passed in a new `ListInspectFindingsRequest`.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} field Field to compute numerical stats on. Supported types are integer, float, date, datetime, timestamp, time.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1Value[]} quantileValues List of 99 values that partition the set of field values into 100 equal sized buckets.
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KMapEstimationConfig} kMapEstimationConfig
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} field
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1BigQueryKey} bigQueryKey
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1RecordSuppression[]} recordSuppressions Configuration defining which records get suppressed entirely. Records that match any suppression rule are omitted from the output [optional].
 */
/**
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1ReplaceConfig[]} replaceConfigs The strings to replace findings text findings with. Must specify at least one of these or one ImageRedactionConfig if redacting images.
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType} infoType Type of information to replace. Only one ReplaceConfig per info_type should be provided. If ReplaceConfig does not have an info_type, the DLP API matches it against all info_types that are found but not specified in another ReplaceConfig.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KMapEstimationResult} kMapEstimationResult
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} field Identifies the column. [required]
 * @property {dlp(v2beta1).GoogleProtobufEmpty} inferred If no semantic tag is indicated, we infer the statistical model from the distribution of values in the input data
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType} infoType A column can be tagged with a InfoType to use the relevant public dataset as a statistical model of population, if available. We currently support US ZIP codes, region codes, ages and genders.
 */
/**

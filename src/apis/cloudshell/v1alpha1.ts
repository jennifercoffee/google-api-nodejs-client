      ...
      publicKeys:
          {
             ...
             * @desc Adds a public SSH key to an environment, allowing clients
             * with the corresponding private key to connect to that environment
             * via SSH. If a key with the same format and content already
             * exists, this will return the existing key.
            ...
            create(
              ...
              createAPIRequest(parameters, callback!);
                ...
                * @desc Removes a public SSH key from an environment. Clients
                * will no longer be able to connect to the environment using the

 ...
 * @type object
 * @property {language(v1beta2).Document} document Input document.
 * @property {string} encodingType The encoding type used by the API to calculate sentence offsets for the sentence sentiment.
 */
/**
 ...
 * @property {language(v1beta2).Sentiment} documentSentiment The overall sentiment for the document. Populated if the user enables AnnotateTextRequest.Features.extract_document_sentiment.
 * @property {language(v1beta2).Entity[]} entities Entities, along with their semantic information, in the input document. Populated if the user enables AnnotateTextRequest.Features.extract_entities.
 * @property {string} language The language of the text, which will be the same as the language specified in the request or, if not specified, the automatically-detected language. See Document.language field for more details.
 * @property {language(v1beta2).Sentence[]} sentences Sentences in the input document. Populated if the user enables AnnotateTextRequest.Features.extract_syntax.
 * @property {language(v1beta2).Token[]} tokens Tokens, along with their syntactic information, in the input document. Populated if the user enables AnnotateTextRequest.Features.extract_syntax.
 */
/**
 ...
 * @memberOf! language(v1beta2)
 * @type object
 * @property {language(v1beta2).EntityMention[]} mentions The mentions of this entity in the input document. The API currently supports proper noun mentions.
 ...
 * @property {language(v1beta2).Sentiment} sentiment For calls to AnalyzeEntitySentiment or if AnnotateTextRequest.Features.extract_entity_sentiment is set to true, this field will contain the aggregate sentiment expressed for this entity in the provided document.
 ...
 * @memberOf! language(v1beta2)
 * @type object
 * @property {language(v1beta2).Sentiment} sentiment For calls to AnalyzeEntitySentiment or if AnnotateTextRequest.Features.extract_entity_sentiment is set to true, this field will contain the sentiment expressed for this mention of the entity in the provided document.
 ...
 * @memberOf! language(v1beta2)
 * @type object
 * @property {boolean} classifyText Classify the full document into categories. If this is true, the API will use the default model which classifies into a [predefined taxonomy](/natural-language/docs/categories).
 ...
 * @memberOf! language(v1beta2)
 * @type object
 * @property {language(v1beta2).Sentiment} sentiment For calls to AnalyzeSentiment or if AnnotateTextRequest.Features.extract_document_sentiment is set to true, this field will contain the sentiment for the sentence.

 ...
 */
export class Fitness extends BaseAPI {
  ...
  users =
      {
        dataset: {
           ...
           * @desc Aggregates data of a certain type or stream into buckets
          ...
          aggregate(
            ...
            const parameters = {
              options: Object.assign(
                  {
                    url: (rootUrl +
                          '/fitness/v1/users/{userId}/dataset:aggregate')
                             .replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST'
                  },
                  options),
        ...
        dataSources: {
           ...
           * @desc Creates a new data source that is unique across all data
           * sources belonging to this user. The data stream ID field can be
           * omitted and will be generated by the server with the correct
           * format. The data stream ID is an ordered combination of some fields
           * from the data source. In addition to the data source fields
           * reflected into the data source ID, the developer project number
           * that is authenticated when creating the data source is included.
          ...
          create(
            ...
            createAPIRequest(parameters, callback!);
              ...
              * @desc Deletes the specified data source. The request will fail
              * if the data source contains any data points.
          ...
          get(params: any, options: MethodOptions|BodyResponseCallback<any>,
            ...
            createAPIRequest(parameters, callback!);
              ...
              * user may have private data sources that are only visible to
          ...
          list(
            ...
            createAPIRequest(parameters, callback!);
              ...
              * @desc Updates the specified data source. The dataStreamId,
              * dataType, type, dataStreamName, and device properties with the
              * exception of version, cannot be modified.  Data sources are
              * identified by their dataStreamId. This method supports patch
              * semantics.
          ...
          dataPointChanges:
              {
                 ...
                 * @desc Queries for user's data point changes for a particular
                 * data source.
          ...
          datasets:
              {
                 ...
                 * @desc Performs an inclusive delete of all data points whose
                 * start and end times have any overlap with the time range
                 * specified by the dataset ID. For most data types, the entire
                 * data point will be deleted. For data types where the time
                 * span represents a consistent value (such as
                 * com.google.activity.segment), and a data point straddles
                 * either end point of the dataset, only the overlapping portion
                ...
                delete(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Returns a dataset containing all data points whose
                    * start and end times overlap with the specified range of
                    * the dataset minimum start time and maximum end time.
                    * Specifically, any data point whose start time is less than
                    * or equal to the dataset end time and whose end time is
                ...
                get(params: any,
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Adds data points to a dataset. The dataset need not
                    * be previously created. All points within the given dataset
                    * will be returned with subsquent calls to retrieve this
                    * dataset. Data points can belong to more than one dataset.

  ...
  folders = {
    ...
    clearOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * merging `Policies` in the resource hierarchy. The returned `Policy`
        * will not have an `etag`set because it is a computed `Policy` across
        * multiple resources.
        * @example
        * // BEFORE RUNNING:
        * // ---------------
    ...
    getEffectiveOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *     resource_: 'folders/my-folder',  // TODO: Update placeholder
        * value.
        *
        *     resource: {
        *       // TODO: Add desired properties to the request body.
    ...
    getOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * `constraintsPage`: console.log(JSON.stringify(constraintsPage[i],
        * null, 2));
        *     }
        *
    ...
    listAvailableOrgPolicyConstraints(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *     if (response.nextPageToken) {
        *       request.resource.pageToken = response.nextPageToken;
        *       cloudResourceManager.folders.listOrgPolicies(request,
        * handlePage);
        *     }
        *   };
        *
    ...
    listOrgPolicies(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * `Policy` for that `Constraint` on the resource if one does not exist.
  ...
  liens = {
    ...
    delete(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *       // TODO: Change code below to process each resource in
        * `liensPage`: console.log(JSON.stringify(liensPage[i], null, 2));
        *     }
        *
        *     if (response.nextPageToken) {
  ...
  organizations = {
    ...
    listOrgPolicies(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * end of the results.  Search will only return organizations on which
        * the user has the permission `resourcemanager.organizations.get`
        * @example
        * // BEFORE RUNNING:
        * // ---------------
        * // 1. If not already done, enable the Google Cloud Resource Manager
    ...
    setIamPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *   };
        *
        *   cloudResourceManager.organizations.setOrgPolicy(request,
        * function(err, response) { if (err) { console.error(err); return;
        *     }
        *
        *     // TODO: Change code below to process the `response` object:
    ...
    setOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * resource name, e.g. "organizations/123".  There are no permissions
  ...
  projects = {
    ...
    clearOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * backoff.  Authorization requires the Google IAM permission
        * `resourcemanager.projects.create` on the specified parent for the new
        * project. The parent is identified by a specified ResourceId, which
        ...
        *   };
        *
        *   cloudResourceManager.projects.create(request, function(err,
        * response) { if (err) { console.error(err); return;
        *     }
        *
        *     // TODO: Change code below to process the `response` object:
    ...
    create(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * the Project if it has a lifecycle state of ACTIVE.  This method
        * changes the Project's lifecycle state from ACTIVE to DELETE_REQUESTED.
        * The deletion starts at an unspecified time, at which point the Project
        * is no longer accessible.  Until the deletion completes, you can check
        * the lifecycle state checked by retrieving the Project with GetProject,
    ...
    getAncestry(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *   var request = {
        *     // The name of the resource to start computing the effective
        * `Policy`. resource_: 'projects/my-project',  // TODO: Update
        * placeholder value.
        *
        *     resource: {
        *       // TODO: Add desired properties to the request body.
    ...
    getEffectiveOrgPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * additional information about resource structure and identification,
    ...
    getIamPolicy(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *   var request = {
        *     // Name of the resource the `Policy` is set on.
        *     resource_: 'projects/my-project',  // TODO: Update placeholder
        * value.
        *
        *     resource: {
        *       // TODO: Add desired properties to the request body.
    ...
    listAvailableOrgPolicyConstraints(
      ...
      createAPIRequest(parameters, callback!);
        ...
        *     if (response.nextPageToken) {
        *       request.resource.pageToken = response.nextPageToken;
        *       cloudResourceManager.projects.listOrgPolicies(request,
        * handlePage);
        *     }
        *   };
        *
    ...
    listOrgPolicies(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * being used before removing or updating its roles.  Authorization
        * requires the Google IAM permission
 ...
 * @memberOf! cloudresourcemanager(v1)
 * @type object
 * @property {cloudresourcemanager(v1).AuditLogConfig[]} auditLogConfigs The configuration for logging of each type of permission. Next ID: 4
 ...
 * @property {string} etag The current version, for concurrency control. Not sending an `etag` will cause the `Policy` to be cleared blindly.
 */
/**
 * @typedef Constraint
 * @memberOf! cloudresourcemanager(v1)
 ...
 * @property {string} description Detailed description of what this `Constraint` controls as well as how and where it is enforced.  Mutable.
 * @property {string} displayName The human readable name.  Mutable.
 * @property {cloudresourcemanager(v1).ListConstraint} listConstraint Defines this constraint as being a ListConstraint.
 * @property {string} name Immutable value, required to globally be unique. For example, `constraints/serviceuser.services`
 ...
 * @memberOf! cloudresourcemanager(v1)
 * @type object
 * @property {cloudresourcemanager(v1).Ancestor[]} ancestor Ancestors are ordered from bottom to top of the resource hierarchy. The first ancestor is the project itself, followed by the project&#39;s parent, etc.
 */
/**
 ...
 * @property {string} name A system-generated unique identifier for this Lien.  Example: `liens/1234abcd`
 * @property {string} origin A stable, user-visible/meaningful string identifying the origin of the Lien, intended to be inspected programmatically. Maximum length of 200 characters.  Example: &#39;compute.googleapis.com&#39;
 * @property {string} parent A reference to the resource this Lien is attached to. The server will validate the parent against those for which Liens are supported.  Example: `projects/1234`
 * @property {string} reason Concise user-visible strings indicating why an action cannot be performed on a resource. Maximum lenth of 200 characters.  Example: &#39;Holds production API key&#39;
 * @property {string[]} restrictions The types of operations which should be blocked as a result of this Lien. Each value should correspond to an IAM permission. The server will validate the permissions against those for which Liens are supported.  An empty list is meaningless and will be rejected.  Example: [&#39;resourcemanager.projects.delete&#39;]
 */
/**
 * @typedef ListAvailableOrgPolicyConstraintsRequest
 * @memberOf! cloudresourcemanager(v1)
 * @type object
 * @property {integer} pageSize Size of the pages to be returned. This is currently unsupported and will be ignored. The server may at any point start using this field to limit page size.
 * @property {string} pageToken Page token used to retrieve the next page. This is currently unsupported and will be ignored. The server may at any point start using this field.
 */
/**
 ...
 * @memberOf! cloudresourcemanager(v1)
 * @type object
 * @property {string} suggestedValue Optional. The Google Cloud Console will try to default to a configuration that matches the value specified in this `Constraint`.
 */
/**
 ...
 * @property {string} constraint The name of the `Constraint` the `Policy` is configuring, for example, `constraints/serviceuser.services`.  Immutable after creation.
 * @property {string} etag An opaque tag indicating the current version of the `Policy`, used for concurrency control.  When the `Policy` is returned from either a `GetPolicy` or a `ListOrgPolicy` request, this `etag` indicates the version of the current `Policy` to use when executing a read-modify-write loop.  When the `Policy` is returned from a `GetEffectivePolicy` request, the `etag` will be unset.  When the `Policy` is used in a `SetOrgPolicy` method, use the `etag` value that was returned from a `GetOrgPolicy` request as part of a read-modify-write loop for concurrency control. Not setting the `etag`in a `SetOrgPolicy` request will result in an unconditional write of the `Policy`.
 * @property {cloudresourcemanager(v1).ListPolicy} listPolicy List of values either allowed or disallowed.
 * @property {cloudresourcemanager(v1).RestoreDefault} restoreDefault Restores the default behavior of the constraint; independent of `Constraint` type.
 * @property {string} updateTime The time stamp the `Policy` was previously updated. This is set by the server, not specified by the caller, and represents the last time a call to `SetOrgPolicy` was made for that `Policy`. Any value set by the client will be ignored.
 ...
 * @property {cloudresourcemanager(v1).Binding[]} bindings Associates a list of `members` to a `role`. `bindings` with no members will result in an error.
 ...
 * @property {cloudresourcemanager(v1).ResourceId} parent An optional reference to a parent Resource.  Supported parent types include &quot;organization&quot; and &quot;folder&quot;. Once set, the parent cannot be cleared. The `parent` can be set on creation or using the `UpdateProject` method; the end user must have the `resourcemanager.projects.create` permission on the parent.  Read-write.
 ...
 * @property {string} type Required field representing the resource type this id is for. At present, the valid types are: &quot;organization&quot;
 */
/**

  ...
  paws = {
    ...
    init(
      ...
      createAPIRequest(parameters, callback!);
        ...
        * the regulator. The Google Spectrum Database does not operate in
        * domains that require notification, so this always yields an
        * UNIMPLEMENTED error.
 ...
 * @property {string} type The message type (e.g., INIT_REQ, AVAIL_SPECTRUM_REQ, ...).  Required field.
 * @property {string} version The PAWS version. Must be exactly 1.0.  Required field.
 */
/**

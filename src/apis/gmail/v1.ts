 ...
 */
export class Gmail extends BaseAPI {
        ...
        drafts:
            {
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Immediately and permanently deletes the specified
                  * draft. Does not simply trash it.
              ...
              list(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Sends the specified, existing draft to the recipients
                  * in the To, Cc, and Bcc headers.
        ...
        labels:
            {
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Immediately and permanently deletes the specified
                  * label and removes it from any messages and threads that it
                  * is applied to.
              ...
              list(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Updates the specified label. This method supports
                  * patch semantics.
        ...
        messages:
            {
               ...
               * @desc Deletes many messages by message ID. Provides no
               * guarantees that messages were not already deleted or even
               * existed at all.
              ...
              batchModify(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Immediately and permanently deletes the specified
                  * message. This operation cannot be undone. Prefer
              ...
              delete(
                ...
                const parameters = {
                  options: Object.assign(
                      {
                        url:
                            (rootUrl + '/gmail/v1/users/{userId}/messages/{id}')
                                .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'DELETE'
                      },
                      options),
              ...
              get(params: any, options: MethodOptions|BodyResponseCallback<any>,
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * standard email delivery scanning and classification similar
                  * to receiving via SMTP. Does not send a message.
              ...
              import(
                ...
                const parameters = {
                  ...
                  params,
                  mediaUrl: (rootUrl +
                             '/upload/gmail/v1/users/{userId}/messages/import')
                                .replace(/([^:]\/)\/+/g, '$1'),
                  requiredParams: ['userId'],
                  pathParams: ['userId'],
                  context: self
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Directly inserts a message into only this user's
                  * mailbox similar to IMAP APPEND, bypassing most scanning and
              ...
              modify(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Sends the specified message to the recipients in the
              ...
              send(
                ...
                const parameters = {
                  options: Object.assign(
                      {
                        url:
                            (rootUrl + '/gmail/v1/users/{userId}/messages/send')
                                .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                      },
                      options),
        ...
        settings:
            {
               ...
               * @desc Gets the auto-forwarding setting for the specified
               * account.
              ...
              getImap(
                ...
                const parameters = {
                  options: Object.assign(
                      {
                        url:
                            (rootUrl + '/gmail/v1/users/{userId}/settings/imap')
                                .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'GET'
                      },
                      options),
              ...
              getVacation(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * account. A verified forwarding address must be specified
                  * when auto-forwarding is enabled.  This method is only
                  * available to service account clients that have been
              ...
              forwardingAddresses:
                  {
                     ...
                     * @desc Creates a forwarding address. If ownership
                     * verification is required, a message will be sent to the
                     * recipient and the resource's verification status will be
                     * set to pending; otherwise, the resource will be created
                     * with verification status set to accepted.  This method is
                     * only available to service account clients that have been
                     * delegated domain-wide authority.
                    ...
                    create(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Deletes the specified forwarding address and
                        * revokes any verification that may have been required.
                        * This method is only available to service account
                        * clients that have been delegated domain-wide
                        * authority.
              ...
              sendAs:
                  {
                     ...
                     * @desc Creates a custom "from" send-as alias. If an SMTP
                     * MSA is specified, Gmail will attempt to connect to the
                     * SMTP service to validate the configuration before
                     * creating the alias. If ownership verification is required
                     * for the alias, a message will be sent to the email
                     * address and the resource's verification status will be
                     * set to pending; otherwise, the resource will be created
                     * with verification status set to accepted. If a signature
                     * is provided, Gmail will sanitize the HTML before saving
                     * it with the alias.  This method is only available to
                     * service account clients that have been delegated
                    ...
                    delete(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Gets the specified send-as alias. Fails with an
                        * HTTP 404 error if the specified address is not a
                    ...
                    get(params: any,
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Lists the send-as aliases for the specified
                        * account. The result includes the primary send-as
                        * address associated with the account as well as any
                        * custom "from" aliases.
                    ...
                    list(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Updates a send-as alias. If a signature is
                        * provided, Gmail will sanitize the HTML before saving
                        * it with the alias.  Addresses other than the primary
                        * address for the account can only be updated by service
                        * account clients that have been delegated domain-wide
                    ...
                    update(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Sends a verification email to the specified
                        * send-as alias address. The verification status must be
                        * pending.  This method is only available to service
                        * account clients that have been delegated domain-wide
                        * authority.
                    ...
                    smimeInfo:
                        {
                           ...
                           * @desc Deletes the specified S/MIME config for the
                           * specified send-as alias.
                          ...
                          delete(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Gets the specified S/MIME config for the
                              * specified send-as alias.
                          ...
                          get(params: any,
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Insert (upload) the given S/MIME config
                              * for the specified send-as alias. Note that
                          ...
                          insert(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Lists S/MIME configs for the specified
                              * send-as alias.
                              * @alias
                              * gmail.users.settings.sendAs.smimeInfo.list
                              * @memberOf! gmail(v1)
                          ...
                          list(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Sets the default S/MIME config for the
                              * specified send-as alias.
                              * @alias
                              * gmail.users.settings.sendAs.smimeInfo.setDefault
                              * @memberOf! gmail(v1)
        ...
        threads:
            {
              ...
              list(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Modifies the labels applied to the thread. This
                  * applies to all messages in the thread.
 ...
 * @memberOf! gmail(v1)
 * @type object
 * @property {gmail(v1).LabelColor} color The color to assign to the label. Color is only available for labels that have their type set to user.
 ...
 * @memberOf! gmail(v1)
 * @type object
 * @property {string} backgroundColor The background color represented as hex string #RRGGBB (ex #000000). This field is required in order to set the color of a label. Only the following predefined set of color values are allowed: #000000, #434343, #666666, #999999, #cccccc, #efefef, #f3f3f3, #ffffff, #fb4c2f, #ffad47, #fad165, #16a766, #43d692, #4a86e8, #a479e2, #f691b3, #f6c5be, #ffe6c7, #fef1d1, #b9e4d0, #c6f3de, #c9daf8, #e4d7f5, #fcdee8, #efa093, #ffd6a2, #fce8b3, #89d3b2, #a0eac9, #a4c2f4, #d0bcf1, #fbc8d9, #e66550, #ffbc6b, #fcda83, #44b984, #68dfa9, #6d9eeb, #b694e8, #f7a7c0, #cc3a21, #eaa041, #f2c960, #149e60, #3dc789, #3c78d8, #8e63ce, #e07798, #ac2b16, #cf8933, #d5ae49, #0b804b, #2a9c68, #285bac, #653e9b, #b65775, #822111, #a46a21, #aa8831, #076239, #1a764d, #1c4587, #41236d, #83334c

      ...
      breakpoints: {
        ...
        list(
          ...
          createAPIRequest(parameters, callback!);
            ...
            * value does not change the breakpoint specification. Updates to the
            * `location`, `condition` and `expressions` fields should not alter
            * the breakpoint semantics. These may only make changes such as
            * canonicalizing a value or snapping the location to the correct
            * line of code.
            * @example
            * // BEFORE RUNNING:
            * // ---------------
            ...
            *     debuggeeId: 'my-debuggee-id',  // TODO: Update placeholder
            * value.
            *
      ...
      breakpoints: {
        ...
        delete(
          ...
          createAPIRequest(parameters, callback!);
            ...
            *   };
            *
            *   cloudDebugger.debugger.debuggees.breakpoints.get(request,
            * function(err, response) { if (err) { console.error(err); return;
            *     }
            *
            *     // TODO: Change code below to process the `response` object:
        ...
        list(
          ...
          createAPIRequest(parameters, callback!);
            ...
            *   };
            *
            *   cloudDebugger.debugger.debuggees.breakpoints.set(request,
            * function(err, response) { if (err) { console.error(err); return;
            *     }
            *
            *     // TODO: Change code below to process the `response` object:
 ...
 * @memberOf! clouddebugger(v2)
 * @type object
 * @property {string} agentVersion Version ID of the agent. Schema: `domain/language-platform/vmajor.minor` (for example `google.com/java-gcp/v1.1`).
 ...
 * @property {clouddebugger(v2).ExtendedSourceContext[]} extSourceContexts References to the locations and revisions of the source code used in the deployed application.
 ...
 * @property {boolean} isInactive If set to `true`, indicates that Controller service does not detect any activity from the debuggee agents and the application is possibly stopped.
 * @property {object} labels A set of custom debuggee properties, populated by the agent, to be displayed to the user.
 * @property {string} project Project the debuggee is associated with. Use project number or id when registering a Google Cloud Platform project.
 * @property {clouddebugger(v2).SourceContext[]} sourceContexts References to the locations and revisions of the source code used in the deployed application.
 ...
 * @property {string} nextWaitToken A token that can be used in the next method call to block until the list of breakpoints changes.
 * @property {boolean} waitExpired If set to `true`, indicates that there is no change to the list of active breakpoints and the server-selected timeout has expired. The `breakpoints` field would be empty and should be ignored.
 */
/**
 * @typedef ListBreakpointsResponse
 * @memberOf! clouddebugger(v2)
 * @type object
 * @property {clouddebugger(v2).Breakpoint[]} breakpoints List of breakpoints matching the request. The fields `id` and `location` are guaranteed to be set on each breakpoint. The fields: `stack_frames`, `evaluated_expressions` and `variable_table` are cleared on each breakpoint regardless of its status.
 ...
 * @memberOf! clouddebugger(v2)
 * @type object
 * @property {clouddebugger(v2).Debuggee[]} debuggees List of debuggees accessible to the calling user. The fields `debuggee.id` and `description` are guaranteed to be set. The `description` field is a human readable field provided by agents and can be displayed to users.
 */
/**
 ...
 * @memberOf! clouddebugger(v2)
 * @type object
 * @property {clouddebugger(v2).Debuggee} debuggee Debuggee resource. The field `id` is guranteed to be set (in addition to the echoed fields). If the field `is_disabled` is set to `true`, the agent should disable itself by removing all breakpoints and detaching from the application. It should however continue to poll `RegisterDebuggee` until reenabled.
 */
/**
 * @typedef RepoId
 * @memberOf! clouddebugger(v2)
 ...
 * @memberOf! clouddebugger(v2)
 * @type object
 * @property {clouddebugger(v2).Breakpoint} breakpoint Updated breakpoint information. The field `id` must be set. The agent must echo all Breakpoint specification fields in the update.
 */
/**

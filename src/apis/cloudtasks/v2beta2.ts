 ...
 */
export class Cloudtasks extends BaseAPI {
    ...
    locations:
        {
           ...
           *     name: 'projects/my-project/locations/my-location',  // TODO:
          ...
          get(params: any, options: MethodOptions|BodyResponseCallback<any>,
            ...
            createAPIRequest(parameters, callback!);
              ...
              * `locationsPage`: console.log(JSON.stringify(locationsPage[i],
              * null, 2));
              *     }
              *
          ...
          queues:
              {
                 ...
                 * @desc Creates a queue.  Queues created with this method allow
                 * tasks to live for a maximum of 31 days. After a task is 31
                 * days old, the task will be deleted regardless of whether it
                 * was dispatched or not.  WARNING: Using this method may have
                ...
                create(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Deletes a queue.  This command will delete the queue
                    * even if it has tasks in it.  Note: If you delete a queue,
                    * a queue with the same name can't be created for 7 days.
                    * WARNING: Using this method may have unintended side
                    * effects if you are using an App Engine `queue.yaml` or
                    * `queue.xml` file to manage your queues. Read [Overview of
                    * Queue Management and
                    * queue.yaml](/cloud-tasks/docs/queue-yaml) before using
                    * this method.
                    * @example
                    * // BEFORE RUNNING:
                    * // ---------------
                ...
                get(params: any,
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Gets the access control policy for a Queue. Returns
                    * an empty policy if the resource exists and does not have a
                    * policy set.  Authorization requires the following [Google
                    * IAM](/iam) permission on the specified resource parent:  *
                    ...
                    * value for this field. resource_:
                    * 'projects/my-project/locations/my-location/queues/my-queue',
                    * // TODO: Update placeholder value.
                    *
                    *     resource: {
                ...
                getIamPolicy(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    *       // TODO: Change code below to process each resource
                    * in `queuesPage`: console.log(JSON.stringify(queuesPage[i],
                    * null, 2));
                    *     }
                    *
                    *     if (response.nextPageToken) {
                ...
                list(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Updates a queue.  This method creates the queue if
                    * it does not exist and updates the queue if it does exist.
                    * Queues created with this method allow tasks to live for a
                    * maximum of 31 days. After a task is 31 days old, the task
                    * will be deleted regardless of whether it was dispatched or
                    * not.  WARNING: Using this method may have unintended side
                    * effects if you are using an App Engine `queue.yaml` or
                    * `queue.xml` file to manage your queues. Read [Overview of
                    * Queue Management and
                    * queue.yaml](/cloud-tasks/docs/queue-yaml) before using
                    ...
                    *     //
                    * `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID`
                    *     // * `PROJECT_ID` can contain uppercase and lowercase
                    * letters,
                    *     // numbers, hyphens, colons, and periods; that is, it
                    * must match
                    *     // the regular expression: `[a-zA-Z\\d-:\\.]+`.
                    *     // * `QUEUE_ID` can contain uppercase and lowercase
                    * letters,
                    *     // numbers, and hyphens; that is, it must match the
                    * regular
                    *     // expression: `[a-zA-Z\\d-]+`. The maximum length is
                    * 100
                    *     // characters.
                ...
                patch(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * system will stop dispatching tasks until the queue is
                    * resumed via ResumeQueue. Tasks can still be added when the
                    * queue is paused. A queue is paused if its state is PAUSED.
                    * @example
                    * // BEFORE RUNNING:
                    * // ---------------
                    * // 1. If not already done, enable the Cloud Tasks API
                ...
                pause(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Purges a queue by deleting all of its tasks.  All
                    * tasks created before this method is called are permanently
                    * deleted.  Purge operations can take up to one minute to
                    * take effect. Tasks might be dispatched before the purge
                ...
                purge(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Resume a queue.  This method resumes a queue after
                    * it has been PAUSED or DISABLED. The state of a queue is
                    * stored in the queue's state; after calling this method it
                    * will be set to RUNNING.  WARNING: Resuming many high-QPS
                    * queues at the same time can lead to target overloading. If
                    * you are resuming high-QPS queues, follow the 500/50/5
                ...
                resume(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Sets the access control policy for a Queue. Replaces
                    * any existing policy.  Note: The Cloud Console does not
                    * check queue-level IAM permissions yet. Project-level
                    * permissions are required to use the Cloud Console.
                    * Authorization requires the following [Google IAM](/iam)
                ...
                setIamPolicy(
                  ...
                  createAPIRequest(parameters, callback!);
                    ...
                    * @desc Returns permissions that a caller has on a Queue. If
                    * the resource does not exist, this will return an empty set
                    * of permissions, not a NOT_FOUND error.  Note: This
                    * operation is designed to be used for building
                    ...
                    * authorize(function(authClient) {
                    *   var request = {
                    *     // REQUIRED: The resource for which the policy detail
                    * is being requested.
                    *     // See the operation documentation for the appropriate
                    * value for this field. resource_:
                    * 'projects/my-project/locations/my-location/queues/my-queue',
                ...
                tasks:
                    {
                       ...
                       * the entity that leased this task must call this method
                       * to indicate that the work associated with the task has
                       * finished.  The worker must acknowledge a task within
                       * the lease_duration or the lease will expire and the
                       * task will become available to be leased again. After
                       * the task is acknowledged, it will not be returned by a
                       * later LeaseTasks, GetTask, or ListTasks.  To
                      ...
                      acknowledge(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * its schedule_time to now. This will make the task
                      ...
                      get(params: any,
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * lease_duration.  This method is invoked by the
                          * worker to obtain a lease. The worker must
                          * acknowledge the task via AcknowledgeTask after they
                          * have performed the work associated with the task.
                          * The payload is intended to store data that the
                          * worker needs to perform the work associated with the
                          * task. To return the payloads in the response, set
                          * response_view to FULL.  A maximum of 10 qps of
                          * LeaseTasks requests are allowed per queue.
                          * RESOURCE_EXHAUSTED is returned when this limit is
                          * exceeded. RESOURCE_EXHAUSTED is also returned when
                      ...
                      lease(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * @desc Lists the tasks in a queue.  By default, only
                          * the BASIC view is retrieved due to performance
                          * considerations; response_view controls the subset of
                      ...
                      list(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * will be returned in the task's schedule_time.
                          * @example
                          * // BEFORE RUNNING:
                          * // ---------------
                          * // 1. If not already done, enable the Cloud Tasks
                      ...
                      renewLease(
                        ...
                        createAPIRequest(parameters, callback!);
                          ...
                          * fix has been made or to manually force a task to be
                          * dispatched now.  When this method is called, Cloud
                          * Tasks will dispatch the task to its target, even if
                          * the queue is PAUSED.  The dispatched task is
                          * returned. That is, the task that is returned
                          * contains the status after the task is dispatched but
                          * before the task is received by its target.  If Cloud
                          * Tasks receives a successful response from the task's
                          * handler, then the task will be deleted; otherwise
                          * the task's schedule_time will be reset to the time
                          * that RunTask was called plus the retry delay
                          * specified in the queue and task's RetryConfig.
                          * RunTask returns NOT_FOUND when it is called on a
                          * task that has already succeeded or permanently
                          * failed. FAILED_PRECONDITION is returned when RunTask
                          * is called on task that is dispatched or already

 ...
 * @property {dns(v1).ResponseHeader} header
 ...
 * @property {dns(v1).DnsKeyDigest[]} digests Cryptographic hashes of the DNSKEY resource record associated with this DnsKey. These digests are needed to construct a DS record that points at this DNS key. Output only.
 * @property {string} id Unique identifier for the resource; defined by the server (output only).
 ...
 * @memberOf! dns(v1)
 * @type object
 * @property {dns(v1).DnsKey[]} dnsKeys The requested resources.
 * @property {dns(v1).ResponseHeader} header
 * @property {string} kind Type of resource.
 * @property {string} nextPageToken The presence of this field indicates that there exist more results following your last page of results in pagination order. To fetch them, make another list request using this value as your pagination token.  In this way you can retrieve the complete contents of even very large collections one page at a time. However, if the contents of the collection change between the first and last paginated list request, the set of all elements returned will be an inconsistent view of the collection. There is no way to retrieve a &quot;snapshot&quot; of collections larger than the maximum page size.
 */
 ...
 * @property {dns(v1).ManagedZoneDnsSecConfig} dnssecConfig DNSSEC configuration.
 * @property {string} id Unique identifier for the resource; defined by the server (output only)
 ...
 * @memberOf! dns(v1)
 * @type object
 * @property {dns(v1).DnsKeySpec[]} defaultKeySpecs Specifies parameters that will be used for generating initial DnsKeys for this ManagedZone. Output only while state is not OFF.
 ...
 * @property {dns(v1).Operation[]} operations The operation resources.
 */
/**
 ...
 * @memberOf! dns(v1)
 * @type object
 * @property {dns(v1).OperationDnsKeyContext} dnsKeyContext Only populated if the operation targeted a DnsKey (output only).
 ...
 * @property {dns(v1).OperationManagedZoneContext} zoneContext Only populated if the operation targeted a ManagedZone (output only).
 */
/**
 * @typedef OperationDnsKeyContext
 * @memberOf! dns(v1)
 * @type object
 * @property {dns(v1).DnsKey} newValue The post-operation DnsKey resource.
 * @property {dns(v1).DnsKey} oldValue The pre-operation DnsKey resource.
 */
/**
 * @typedef OperationManagedZoneContext
 * @memberOf! dns(v1)
 * @type object
 * @property {dns(v1).ManagedZone} newValue The post-operation ManagedZone resource.
 * @property {dns(v1).ManagedZone} oldValue The pre-operation ManagedZone resource.
 */
/**
 * @typedef Project
 * @memberOf! dns(v1)
 ...
 * @property {dns(v1).DnsKeySpec[]} whitelistedKeySpecs DNSSEC algorithm and key length types that can be used for DnsKeys.
 */
/**

 ...
 */
export class Toolresults extends BaseAPI {
  ...
  projects =
      {
         ...
         * @desc Gets the Tool Results settings for a project.  May return any
         * of the following canonical error codes:  - PERMISSION_DENIED - if the
         * user is not authorized to read from project
        ...
        getSettings(
          ...
          createAPIRequest(parameters, callback!);
            ...
            * bucket, to be used as the default bucket for this project. The
            * bucket is created in an FTL-own storage project. Except for in
            ...
            * objects older than 90 days.  The bucket is created with the
            * following permissions: - Owner access for owners of central
            * storage project (FTL-owned) - Writer access for owners/editors of
            * customer project - Reader access for viewers of customer project
            * The default ACL on objects created in the bucket is: - Owner
            * access for owners of central storage project - Reader access for
            * owners/editors/viewers of customer project See Google Cloud
            * Storage documentation for more details.  If there is already a
            * default bucket set and the project can access the bucket, this
            * call does nothing. However, if the project doesn't have the
            * permission to access the bucket or the bucket is deleted, a new
            * bucket will be created.  May return any canonical error codes,
            * including the following:  - PERMISSION_DENIED - if the user is not
        ...
        histories:
            {
               ...
               * @desc Creates a History.  The returned History will have the id
              ...
              create(
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Gets a History.  May return any of the following
                  * canonical error codes:  - PERMISSION_DENIED - if the user is
                  * not authorized to read project - INVALID_ARGUMENT - if the
                  * request is malformed - NOT_FOUND - if the History does not
                  * exist
              ...
              get(params: any, options: MethodOptions|BodyResponseCallback<any>,
                ...
                createAPIRequest(parameters, callback!);
                  ...
                  * @desc Lists Histories for a given Project.  The histories
                  * are sorted by modification time in descending order. The
                  * history_id key will be used to order the history with the
                  * same modification time.  May return any of the following
                  * canonical error codes:  - PERMISSION_DENIED - if the user is
                  * not authorized to read project - INVALID_ARGUMENT - if the
                  * request is malformed - NOT_FOUND - if the History does not
                  * exist
              ...
              executions:
                  {
                     ...
                     * @desc Creates an Execution.  The returned Execution will
                     * have the id set.  May return any of the following
                     * canonical error codes:  - PERMISSION_DENIED - if the user
                     * is not authorized to write to project - INVALID_ARGUMENT
                    ...
                    create(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Gets an Execution.  May return any of the
                        * following canonical error codes:  - PERMISSION_DENIED
                        * - if the user is not authorized to write to project -
                    ...
                    get(params: any,
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Lists Histories for a given Project.  The
                        * executions are sorted by creation_time in descending
                        * order. The execution_id key will be used to order the
                        * executions with the same creation_time.  May return
                        * any of the following canonical error codes:  -
                        * PERMISSION_DENIED - if the user is not authorized to
                        * read project - INVALID_ARGUMENT - if the request is
                        * malformed - NOT_FOUND - if the containing History does
                        * not exist
                    ...
                    list(
                      ...
                      createAPIRequest(parameters, callback!);
                        ...
                        * @desc Updates an existing Execution with the supplied
                        * partial entity.  May return any of the following
                        * canonical error codes:  - PERMISSION_DENIED - if the
                        * user is not authorized to write to project -
                        * INVALID_ARGUMENT - if the request is malformed -
                        * FAILED_PRECONDITION - if the requested state
                        * transition is illegal - NOT_FOUND - if the containing
                    ...
                    clusters:
                        {
                           ...
                           * @desc Retrieves a single screenshot cluster by its
                           * ID
                           * @alias
                           * toolresults.projects.histories.executions.clusters.get
                           * @memberOf! toolresults(v1beta3)
                          ...
                          get(params: any,
                            ...
                            const parameters = {
                              ...
                              pathParams: [
                                'clusterId', 'executionId', 'historyId',
                                'projectId'
                              ],
                              context: self
                            };
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Lists Screenshot Clusters  Returns the
                              * list of screenshot clusters corresponding to an
                              * execution. Screenshot clusters are created after
                              * the execution is finished. Clusters are created
                              * from a set of screenshots. Between any two
                              * screenshots, a matching score is calculated
                              * based off their metadata that determines how
                              * similar they are. Screenshots are placed in the
                              * cluster that has screens which have the highest
                              * matching scores.
                              * @alias
                              * toolresults.projects.histories.executions.clusters.list
                              * @memberOf! toolresults(v1beta3)
                    ...
                    steps:
                        {
                           ...
                           * @desc Creates a Step.  The returned Step will have
                           * the id set.  May return any of the following
                           * canonical error codes:  - PERMISSION_DENIED - if
                           * the user is not authorized to write to project -
                           * INVALID_ARGUMENT - if the request is malformed -
                           * FAILED_PRECONDITION - if the step is too large
                           * (more than 10Mib) - NOT_FOUND - if the containing
                          ...
                          create(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Gets a Step.  May return any of the
                              * following canonical error codes:  -
                              * PERMISSION_DENIED - if the user is not
                              * authorized to read project - INVALID_ARGUMENT -
                              * if the request is malformed - NOT_FOUND - if the
                              * Step does not exist
                              * @alias
                              * toolresults.projects.histories.executions.steps.get
                          ...
                          get(params: any,
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Retrieves a PerfMetricsSummary.  May
                              * return any of the following error code(s): -
                              * NOT_FOUND - The specified PerfMetricsSummary
                              * does not exist
                              * @alias
                              * toolresults.projects.histories.executions.steps.getPerfMetricsSummary
                              * @memberOf! toolresults(v1beta3)
                          ...
                          getPerfMetricsSummary(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Lists Steps for a given Execution.  The
                              * steps are sorted by creation_time in descending
                              * order. The step_id key will be used to order the
                              * steps with the same creation_time.  May return
                              * any of the following canonical error codes:  -
                              * PERMISSION_DENIED - if the user is not
                              * authorized to read project - INVALID_ARGUMENT -
                              * if the request is malformed -
                              * FAILED_PRECONDITION - if an argument in the
                              * request happens to be invalid; e.g. if an
                              * attempt is made to list the children of a
                              * nonexistent Step - NOT_FOUND - if the containing
                              * Execution does not exist
                              * @alias
                              * toolresults.projects.histories.executions.steps.list
                              * @memberOf! toolresults(v1beta3)
                          ...
                          list(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Updates an existing Step with the supplied
                              * partial entity.  May return any of the following
                              * canonical error codes:  - PERMISSION_DENIED - if
                              * the user is not authorized to write project -
                              * INVALID_ARGUMENT - if the request is malformed -
                              * FAILED_PRECONDITION - if the requested state
                              * transition is illegal (e.g try to upload a
                              * duplicate xml file), if the updated step is too
                              * large (more than 10Mib) - NOT_FOUND - if the
                          ...
                          patch(
                            ...
                            createAPIRequest(parameters, callback!);
                              ...
                              * @desc Publish xml files to an existing Step.
                              * May return any of the following canonical error
                              * codes:  - PERMISSION_DENIED - if the user is not
                              * authorized to write project - INVALID_ARGUMENT -
                              * if the request is malformed -
                              * FAILED_PRECONDITION - if the requested state
                              * transition is illegal, e.g try to upload a
                              * duplicate xml file or a file too large. -
                              * NOT_FOUND - if the containing Execution does not
                              * exist
                              * @alias
                              * toolresults.projects.histories.executions.steps.publishXunitXmlFiles
                              * @memberOf! toolresults(v1beta3)
                          ...
                          perfMetricsSummary:
                              {
                                 ...
                                 * @desc Creates a PerfMetricsSummary resource.
                                 * Returns the existing one if it has already
                                 * been created.  May return any of the
                                 * following error code(s): - NOT_FOUND - The
                          ...
                          perfSampleSeries:
                              {
                                 ...
                                 * @desc Creates a PerfSampleSeries.  May return
                                 * any of the following error code(s): -
                                 * ALREADY_EXISTS - PerfMetricSummary already
                                 * exists for the given Step - NOT_FOUND - The
                                 * containing Step does not exist
                                 * @alias
                                 * toolresults.projects.histories.executions.steps.perfSampleSeries.create
                                 * @memberOf! toolresults(v1beta3)
                                ...
                                create(
                                  ...
                                  createAPIRequest(parameters, callback!);
                                    ...
                                    * @desc Gets a PerfSampleSeries.  May return
                                    * any of the following error code(s): -
                                    * NOT_FOUND - The specified PerfSampleSeries
                                    * does not exist
                                    * @alias
                                    * toolresults.projects.histories.executions.steps.perfSampleSeries.get
                                    * @memberOf! toolresults(v1beta3)
                                ...
                                get(params: any,
                                  ...
                                  createAPIRequest(parameters, callback!);
                                    ...
                                    * Step.  The request provides an optional
                                    * filter which specifies one or more
                                    * PerfMetricsType to include in the result;
                                    * if none returns all. The resulting
                                    * PerfSampleSeries are sorted by ids.  May
                                    * return any of the following canonical
                                    * error codes: - NOT_FOUND - The containing
                                    * Step does not exist
                                    * @alias
                                    * toolresults.projects.histories.executions.steps.perfSampleSeries.list
                                    * @memberOf! toolresults(v1beta3)
                                ...
                                samples:
                                    {
                                       ...
                                       * a client can submit multiple batches of
                                       * Perf Samples through repeated calls to
                                       * this method in order to split up a
                                       * large request payload - duplicates and
                                       * existing timestamp entries will be
                                       * ignored. - the batch operation may
                                       * partially succeed - the set of elements
                                       * successfully inserted is returned in
                                       * the response (omits items which already
                                       * existed in the database).  May return
                                       * any of the following canonical error
                                       * codes: - NOT_FOUND - The containing
                                      ...
                                      batchCreate(
                                        ...
                                        createAPIRequest(parameters, callback!);
                                          ...
                                          * @desc Lists the Performance Samples
                                          * of a given Sample Series - The list
                                          * results are sorted by timestamps
                                          * ascending - The default page size is
                                          * 500 samples; and maximum size
                                          * allowed 5000 - The response token
                                          * indicates the last returned
                                          * PerfSample timestamp - When the
                                          * results size exceeds the page size,
                                          * submit a subsequent request
                                          * including the page token to return
                                          * the rest of the samples up to the
                                          * page limit  May return any of the
                                          * following canonical error codes: -
                                          * OUT_OF_RANGE - The specified request
                                          * page_token is out of valid range -
                                          * NOT_FOUND - The containing
                                          * PerfSampleSeries does not exist
                                          * @alias
                                          * toolresults.projects.histories.executions.steps.perfSampleSeries.samples.list
                                          * @memberOf! toolresults(v1beta3)
                          ...
                          thumbnails:
                              {
                                 ...
                                 * @desc Lists thumbnails of images attached to
                                 * a step.  May return any of the following
                                 * canonical error codes: - PERMISSION_DENIED -
                                 * if the user is not authorized to read from
                                 * the project, or from any of the images -
                                 * INVALID_ARGUMENT - if the request is
                                 * malformed - NOT_FOUND - if the step does not

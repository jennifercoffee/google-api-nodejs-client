 ...
 */
export class Adsense extends BaseAPI {
          ...
          list(
            ...
            const parameters = {
              options: Object.assign(
                  {
                    url: (rootUrl +
                          '/adsense/v1.4/accounts/{accountId}/adclients')
                             .replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET'
                  },
                  options),
    ...
    adunits:
        {
          ...
          getAdCode(
            ...
            createAPIRequest(parameters, callback!);
              ...
              * @desc List all ad units in the specified ad client for the
              * specified account.
          ...
          customchannels:
              {
                 ...
                 * @desc List all custom channels which the specified ad unit
                 * belongs to.
    ...
    alerts:
        {
           ...
           * @desc Dismiss (delete) the specified alert from the specified
          ...
          list(
            ...
            const parameters = {
              options: Object.assign(
                  {
                    url: (rootUrl +
                          '/adsense/v1.4/accounts/{accountId}/payments')
                             .replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET'
                  },
                  options),
    ...
    reports:
        {
          ...
          saved: {
             ...
             * @desc Generate an AdSense report based on the saved report ID
